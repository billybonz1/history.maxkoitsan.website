    ...
    <div class="site">
        <header>
            <div class="desktop_header">
                ...
                <div class="bottom_header local_header">
                    <div class="container">
                        <div class="header_block">
                            <div class="logo_block">
                                ...
                                <a href="<?php echo get_permalink( $post->post_parent ); ?>">
                                    <?php 
                                        ...
                                        $menu = wp_get_nav_menu_object($locations['menu-2']);//get the menu object
                                        ?>
                                    <? $logo_header_towns = get_field('logo_header_town', 'option');
					                        if($logo_header_towns): ?>
                                    <img src="<?= $logo_header_towns ?>" alt="">
                                    <? endif; ?>
                                    <p class="logo_title"><?php echo $menu->name; ?></p>
                                </a>
                                <?php } ?>
                            </div>
