                        ...
                        <div class="podcast">
                            <div class="top_audio">
                                <div class="title_part">
                                    <img src="<?= get_template_directory_uri() ?>/img/blog/podcast_icon_yellow.svg"
                                        alt="">
                                    <p class="podcast__episode_title"><?php the_title(); ?></p>
                                </div>
                            </div>
                            <div class="podcast__meta">
                                <audio controls width="100%">
                                    <source src="<?php the_field('podcast_audio', get_the_ID()); ?>">
